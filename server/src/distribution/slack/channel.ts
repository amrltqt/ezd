...
import { DistributionEnum, DistributionTarget, DistributionUnit } from "../../definitions";
...
function isSlackChannelTarget(obj: DistributionTarget): obj is SlackChannelTarget {
    return (
        obj.type === DistributionEnum.SlackChannel && 
        "id" in obj && "comment" in obj && "filename" in obj
    );
}
